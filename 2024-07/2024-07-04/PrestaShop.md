...
|@typescript-eslint/typescript-estree|7.11.0|间接依赖|npm|
...
|js-image-generator|1.0.4|间接依赖|npm|
...
|libsodium-wrappers|0.7.13|间接依赖|npm|
...
|@typescript-eslint/utils|7.11.0|间接依赖|npm|
|open|8.4.0|间接依赖|npm|
...
|@typescript-eslint/scope-manager|7.11.0|间接依赖|npm|
...
|@s3pweb/keycloak-admin-client-cjs|22.0.1|间接依赖|npm|
...
|@typescript-eslint/types|7.11.0|间接依赖|npm|
...
|email-validator|2.0.4|直接依赖|npm|
