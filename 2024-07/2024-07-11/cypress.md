...
|@volar/typescript|2.2.4|间接依赖|npm|
...
|@babel/plugin-transform-private-methods|7.24.6|间接依赖|npm|
...
|@types/chrome-remote-interface|0.31.11|直接依赖|npm|
...
|glob|9.3.5|间接依赖|npm|
|@babel/plugin-transform-modules-umd|7.24.6|间接依赖|npm|
...
|@babel/plugin-transform-sticky-regex|7.24.6|间接依赖|npm|
...
|@smithy/protocol-http|3.0.12|间接依赖|npm|
...
|simple-bin-help|1.8.0|间接依赖|npm|
...
|find-test-names|1.28.18|直接依赖|npm|
...
|@smithy/util-waiter|2.0.16|间接依赖|npm|
...
|@babel/plugin-bugfix-safari-id-destructuring-collision-in-function-expression|7.24.6|间接依赖|npm|
...
|glob|7.1.3|间接依赖|npm|
|@percy/webdriver-utils|1.27.4|间接依赖|npm|
...
|@jsdevtools/ez-spawn|3.0.4|间接依赖|npm|
...
|@babel/generator|7.24.5|直接依赖|npm|
...
|@babel/plugin-transform-duplicate-keys|7.24.6|间接依赖|npm|
...
|@aws-sdk/xml-builder|3.485.0|间接依赖|npm|
...
|@antfu/install-pkg|0.3.3|间接依赖|npm|
...
|@babel/plugin-bugfix-v8-spread-parameters-in-optional-chaining|7.24.6|间接依赖|npm|
...
|@smithy/eventstream-serde-universal|2.0.16|间接依赖|npm|
...
|@intlify/unplugin-vue-i18n|4.0.0|直接依赖|npm|
...
|@babel/helper-replace-supers|7.24.6|间接依赖|npm|
...
|@babel/plugin-transform-unicode-escapes|7.24.6|间接依赖|npm|
...
|@babel/plugin-proposal-decorators|7.24.1|直接依赖|npm|
...
|@aws-sdk/credential-provider-sso|3.485.0|间接依赖|npm|
|@graphql-tools/url-loader|7.2.0|间接依赖|npm|
|is-core-module|2.13.1|间接依赖|npm|
|strip-ansi|3.0.1|间接依赖|npm|
|type-detect|4.0.8|间接依赖|npm|
|@babel/plugin-bugfix-firefox-class-in-computed-class-key|7.24.6|间接依赖|npm|
...
|@babel/traverse|7.24.7|直接依赖|npm|
|@schematics/angular|14.2.1|间接依赖|npm|
|chai-as-promised|7.1.1|直接依赖|npm|
|@aws-sdk/credential-provider-process|3.485.0|间接依赖|npm|
|semver|7.6.0|直接依赖|npm|
...
|@iconify-json/mdi|1.1.63|直接依赖|npm|
...
|browserify-sign|4.2.2|直接依赖|npm|
...
|vue-tsc|2.0.19|直接依赖|npm|
|emojis-list|3.0.0|间接依赖|npm|
|@svgr/plugin-jsx|8.0.1|间接依赖|npm|
|@rollup/rollup-linux-s390x-gnu|4.14.1|直接依赖|npm|
...
|@ffprobe-installer/linux-x64|5.2.0|直接依赖|npm|
...
|arg|4.1.0|间接依赖|npm|
|@babel/plugin-transform-dotall-regex|7.24.6|间接依赖|npm|
...
|@cypress-design/vue-icon|0.26.0|直接依赖|npm|
...
|@vitejs/plugin-legacy|5.4.0|直接依赖|npm|
|postcss-nested|4.2.3|间接依赖|npm|
|@jimp/plugin-contain|0.22.12|间接依赖|npm|
|minipass|3.1.6|间接依赖|npm|
|@babel/plugin-transform-dynamic-import|7.24.6|间接依赖|npm|
...
|vite-plugin-vue-layouts|0.11.0|直接依赖|npm|
...
|@aws-sdk/region-config-resolver|3.485.0|间接依赖|npm|
...
|@vitejs/plugin-react|4.3.0|直接依赖|npm|
...
|muggle-string|0.4.1|间接依赖|npm|
|postcss|8.4.38|直接依赖|npm|
|arr-diff|4.0.0|间接依赖|npm|
|@babel/plugin-transform-computed-properties|7.24.6|间接依赖|npm|
...
|@volar/source-map|2.2.4|间接依赖|npm|
...
|@babel/preset-env|7.24.6|间接依赖|npm|
...
|@babel/plugin-transform-logical-assignment-operators|7.24.6|间接依赖|npm|
...
|@types/webpack|4.41.38|直接依赖|npm|
...
|@cypress-design/vue-button|0.11.6|直接依赖|npm|
...
|vite-plugin-pages|0.32.1|直接依赖|npm|
...
|@babel/plugin-transform-parameters|7.24.6|间接依赖|npm|
...
|@babel/plugin-syntax-import-assertions|7.24.6|间接依赖|npm|
...
|@babel/plugin-transform-block-scoped-functions|7.24.6|间接依赖|npm|
|prr|1.0.1|间接依赖|npm|
...
|@rollup/rollup-android-arm64|4.14.1|直接依赖|npm|
...
|@babel/plugin-transform-exponentiation-operator|7.24.6|间接依赖|npm|
|yargs-parser|13.1.1|间接依赖|npm|
|gravatar|1.8.0|直接依赖|npm|
|@types/jsonwebtoken|9.0.5|间接依赖|npm|
|@babel/plugin-transform-private-property-in-object|7.24.5|直接依赖|npm|
|lodash.isarray|3.0.4|间接依赖|npm|
|camelcase|3.0.0|间接依赖|npm|
|@babel/plugin-transform-object-rest-spread|7.24.5|直接依赖|npm|
...
|@babel/plugin-transform-typeof-symbol|7.24.6|间接依赖|npm|
...
|@aws-sdk/middleware-bucket-endpoint|3.485.0|间接依赖|npm|
|@smithy/util-defaults-mode-browser|2.0.24|间接依赖|npm|
|body|5.1.0|间接依赖|npm|
...
|@smithy/types|2.8.0|间接依赖|npm|
|hasown|2.0.2|间接依赖|npm|
|conventional-changelog-core|4.2.4|间接依赖|npm|
|@aws-sdk/credential-provider-ini|3.485.0|间接依赖|npm|
...
|@babel/plugin-transform-reserved-words|7.24.6|间接依赖|npm|
...
|@babel/plugin-transform-unicode-property-regex|7.24.6|间接依赖|npm|
...
|@babel/helper-optimise-call-expression|7.24.6|间接依赖|npm|
...
|@babel/plugin-transform-optional-catch-binding|7.24.6|间接依赖|npm|
...
|@ffprobe-installer/linux-arm|5.2.0|直接依赖|npm|
...
|@octokit/request|8.1.6|间接依赖|npm|
...
|@babel/plugin-transform-class-properties|7.24.1|直接依赖|npm|
...
|@babel/plugin-transform-react-display-name|7.24.6|间接依赖|npm|
|snap-shot-it|7.9.10|直接依赖|npm|
...
|@babel/helper-wrap-function|7.24.6|间接依赖|npm|
...
|@babel/plugin-transform-member-expression-literals|7.24.6|间接依赖|npm|
...
|@smithy/util-endpoints|1.0.8|间接依赖|npm|
...
|@babel/plugin-transform-unicode-regex|7.24.6|间接依赖|npm|
...
|@ffprobe-installer/win32-x64|5.1.0|直接依赖|npm|
...
|yaml-eslint-parser|1.2.2|间接依赖|npm|
...
|@aws-sdk/util-user-agent-node|3.485.0|间接依赖|npm|
...
|@cypress/unique-selector|0.0.5|直接依赖|npm|
...
|@octokit/auth-oauth-device|6.0.1|间接依赖|npm|
...
|@babel/plugin-transform-modules-amd|7.24.6|间接依赖|npm|
...
|@vue/babel-plugin-resolve-type|1.2.2|间接依赖|npm|
...
|@babel/helper-builder-binary-assignment-operator-visitor|7.24.6|间接依赖|npm|
...
|webpack-dev-server-5|5.0.4|直接依赖|npm|
...
|@octokit/auth-oauth-app|7.0.1|间接依赖|npm|
|es-get-iterator|1.1.3|间接依赖|npm|
|@babel/plugin-bugfix-v8-static-class-fields-redefine-readonly|7.24.6|间接依赖|npm|
|elegant-spinner|1.0.1|间接依赖|npm|
|global-agent|3.0.0|直接依赖|npm|
|wordwrap|0.0.3|间接依赖|npm|
|@babel/plugin-transform-class-properties|7.24.6|间接依赖|npm|
...
|@smithy/url-parser|2.0.16|间接依赖|npm|
|qs|6.5.2|间接依赖|npm|
...
|@babel/code-frame|7.24.7|直接依赖|npm|
...
|@typescript-eslint/parser|7.2.0|直接依赖|npm|
|react-dom|15.7.0|间接依赖|npm|
|node-addon-api|3.2.1|间接依赖|npm|
|jiti|1.18.2|间接依赖|npm|
|@babel/plugin-transform-destructuring|7.24.6|间接依赖|npm|
...
|@babel/plugin-transform-arrow-functions|7.24.6|间接依赖|npm|
