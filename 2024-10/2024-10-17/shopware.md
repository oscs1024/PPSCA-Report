...
|vuex|4.1.0|间接依赖|npm|
|pino|8.21.0|间接依赖|npm|
|define-property|1.0.0|间接依赖|npm|
|bcrypt-pbkdf|1.0.2|间接依赖|npm|
|type-detect|4.0.8|间接依赖|npm|
|sonic-boom|3.8.1|间接依赖|npm|
...
|@currents/playwright|1.5.11|间接依赖|npm|
...
|@vue/runtime-core|3.5.6|间接依赖|npm|
...
|@vue/compiler-dom|3.5.6|间接依赖|npm|
...
|@vue/compiler-ssr|3.5.6|间接依赖|npm|
...
|@shopware-ag/meteor-admin-sdk|5.5.0|间接依赖|npm|
...
|twig/twig|^3.14.0|间接依赖|composer|
...
|@shopware-ag/acceptance-test-suite|3.8.4|间接依赖|npm|
